...
#define NAME_SERVICE "Losowa Szansa (10-35%) na bilet Jackpot pod koniec mapy"
#define DESC_SERVICE "1035jpticket"
#define FLAGS "o"
...
{
	{ "4,92",  "\wSMS:\y 4,92zl.\d|\w Przelew:\y 2,00zl\d|\w PSC:\y 2,00zl." 	},	// 7 Dni
	{ "11,07", "\wSMS:\y 11,07zl.\d|\w Przelew:\y 8,00zl\d|\w PSC:\y 9,00zl." 	},	// 14 Dni
	{ "17,22", "\wSMS:\y 17,22zl.\d|\w Przelew:\y 15,00zl\d|\w PSC:\y 16,00zl." },	// 30 Dni
	{ "23,37", "\wSMS:\y 23,37zl.\d|\w Przelew:\y 22,00zl\d|\w PSC:\y 23,00zl." },	// 60 Dni
	{ "30,75", "\wSMS:\y 30,75zl.\d|\w Przelew:\y 28,00zl\d|\w PSC:\y 29,00zl."	}	// 90 Dni
};
